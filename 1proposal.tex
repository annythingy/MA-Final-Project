...
\begin{titlepage}
    \begin{center}
        ...
        \LARGE \textsc{Peripheral Play Prospects}
    \end{center}
    \vfill
...
\end{titlepage}
\clearpage\newgeometry{left=1.1in, right=2cm, top=2cm, bottom=1in}
...
\section{Survey of Sources}\wordCount{960}{1500}
    \todo[def]{Why is the research being undertaken? because vibes!}
...
\subparagraph{Dragon Quest I}\parencite{dragonquest1986}
    \todo[gpt]{Early JRPG
        Investment - lengthy play sessions, manual-driven mechanics, and emergent community around walkthroughs.
        1.Manual Mapping and Player Imagination
            The game world was simple and required lots of wandering, grinding, and guesswork.
            Players had to draw maps, jot down town names, and manually track quests and clues.
            Emulated versions with QoL updates often remove this friction.
        2. Supplementary Material Was Crucial
            The original Japanese release included a detailed manual with monster illustrations, Hints, lore setup, and even walkthrough sections; there was also promotional manga and cross-media support, especially in later titles
        3. Emergence of a Genre (But Not Yet a Blueprint)
            At the time of release, it wasn't following a well-established formula but defined JRPGs to a great extent.
            Early reception was mixed, players had to develop new playstyles like grinding.
            Cultural Moment	In Japan, it was released into an infant console gaming culture. The response helped shape how audiences engaged with fantasy and how RPGs developed worldwide.
            Materiality	The box art, manual, and cartridge were the game as much as the 8-bit world onscreen.
        Theory: Friedrich Kittler: Emphasizes how media technology determines UX - NES constraints + JRPG design = a new literacy.
        Questions:
...
\begin{multicols}{3}
    \textsc{Paratextuality}\phantom{.}\\ \todo[add]{extra content} \columnbreak
    \textsc{Physicality}\phantom{.}\\ 
    \todo[add]{Commitment shaped by hardware constraints, difficulty, as well as a contrived saving system in the JP version.} \columnbreak
    \textsc{Popularity}\phantom{.}\\ \todo[add]{social rituals}
\end{multicols}
...
\subparagraph{Startropics}\parencite{startropics1990}
    \todo[add]{A letter packed with the game needed to be dipped in water to reveal a secret code (747).}
    \todo[gpt]{External Narrative Elements	physical artefact requiring real-world interaction for in-game progression
            Players who emulate can hit a dead end unless they know the code.
        The challenge of preserving the circumstances together with the software 
        Paratext as a Mechanic - like Infocom's feelies, it's between fundamental and supplemental 
        Questions:
            How do integrated physical artefacts contribute to the completeness of the experience?
            What are the consequences of removing or simulating physical components in digital re-releases?
            Can a moment of material interaction redefine a player's understanding the game?}
\begin{multicols}{3}
    \textsc{Paratextuality}\phantom{.}\\ \todo[add]{extra content} \columnbreak
    \textsc{Physicality}\phantom{.}\\ \todo[add]{physical stuff} \columnbreak
    \textsc{Popularity}\phantom{.}\\ \todo[add]{social rituals}
...
\section{Methodology}\wordCount{34}{200}     
    \par \todo[def]{Justify and explain:\\
        how the methods support the research and inform practice\\
        why they are the best option\\
        what approach you will take, \\
        what will you focus on (art, mechanics, tech and interface implementation, etc.),\\
        and how this all connects to the question.\\
        How will the game incorporate the methods?.}
...
\section{Production Plan}\wordCount{218}{100}
\begin{figure}[ht]\centering    
    ...
    \begin{tikzpicture}
        ...
        \draw[color=chap1,>=triangle 45 reversed, <-] (6.24,0) -- (6.24,0.4) node[above, align=center, text=chap1] {First 3 chapters and a\\game design document};
        \draw[color=chap2,>=triangle 45 reversed, <-] (8.42,0) -- (8.42,1.4) node[above, align=center, text=chap3] {RtD - chapter and\\vertical prototype};
        \draw[color=chap3,>=triangle 45 reversed, <-] (10.4,0) -- (10.4,0.2) node[above, align=center, text=chap4] {Essay-written;\\artifact-presentable \\supplementals-ongoing};
