...
\begin{titlepage}\centering
    ...
    \vspace{1cm}\\\texttt{\LARGE 2441871}\vfill
        \todo[tip,inline]{Font: Arial or Times New Roman.}
        \todo[tip,inline]{Double line spacing, except for indented quotations and footnotes.}
        \todo[tip,inline]{Quotations of 40+ words or 4+ lines: separate indented text blocks w/o quotation marks.}
    \vfill Department of Arts and Humanities, Brunel University London
\end{titlepage}

\tableofcontents\begingroup\let\clearpage\relax\vspace{-1cm}\listoffigures\endgroup
\begin{my-abstract}
...
\end{figure}
    ...
    \todo[add]{Connect to writtten part}
    \vfill
...
\chapter{Development}
    ...
    \todo[add]{Explain how in interrogating the question via prototype design, theory informed practice and vice versa}
    \todo[add]{Recognise any setbacks or limitations.}
    \todo[add]{Primary sources that inspired direction: 
        \\ Space Invaders loading mini-game
        \\ Sims x2 cases
        \\ UFO50
        \\ \cite{inscryption2021}
        \\ Vectrex}
    \todo[ref,inline]{Guidance from reading: \citebook{rusch}}

\newpage

\newpage\section{The Lost AMOLED}
...
Although they have been swapped and scrambled into vague equivalents, most names within this alternate universe originate from the ASOUE books.\par
    \todo[ref]{cite}
...
\subsection{Preservation}\hfill\textit{Physicality + Popularity}
    \todo[add]{Describe the hardware quirks
        dials, 2 screens?}
    \todo[gpt]{The state of survival, degradation, and community efforts to archive or interpret the game.
        ...
        \\\hspace{8mm}Confirm what game components survived
...
\subsection{Personalisation}\hfill\textit{Paratextuality + Popularity}
    \todo[gpt]{How community interpretations and practices shape legacy.
...
\newpage\section{Product}
    \todo[add]{Why does the mini-game exist?
        Calibration for both platform and player
        Checking controls work propery while getting used to them and learning tip\&tricks}
