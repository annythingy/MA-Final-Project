...
\begingroup\let\clearpage\relax\listoffigures\endgroup\vfill
...
\chapter{Case Studies}
    ...
    \todo[add]{CASE: Feelies plus \citetitle{startropics1990}}
...
\end{figure}
    ...
    \todo[dev]{score $\to$ loading progress $\to$ full bar $\to$ press start to end game}
...
\titleformat{\chapter}[hang]{\bfseries\LARGE\scshape}{Appendix \thechapter}{32ex}{} \appendix

\chapter{Paratexts}                        \label{apdx:paratxt}
\section{Manual}                           \label{apdx:manual}
    \todo[dev]{Lay out layout}
    \todo[dev]{Controls}
    \todo[app]{Setting and Gameplay}
...
\end{figure}
\newpage\subsection*{A.2.2 \quad Webpage review}          \label{apdx:web-art}
...
\newpage\listoftodos[\vspace{-32mm}{TO-DO List}\vspace{-16mm}]
\end{document}