...
\begin{titlepage}
    ...
    \begin{figure}[h!]\centering
        \includegraphics[width=0.6\linewidth, decodearray={0.32 1 0.32 1 0.32 1}]{img/game-room.png}
    \end{figure}\nocite{dsonyy}
...
\subparagraph{Legend of Zelda}\parencite{zelda1}
\begin{multicols}{3}
...
\subparagraph{Startropics}\parencite{startropics}
\begin{multicols}{3}
...
\section{Methodology}\wordCount{34}{200}\par
...
\newpage\printbibliography[title={Ludography},type=software]
    \todo[inline, color = green!32]{'Is it mandatory to add \textbf{date played}? I don't see much value in that information:\\
